...
const About = () => {
    return(
        <div className='w-full h-100% text-orange-200 px-8 pt-40  bg-[#8d450c] md:h-screen pb-20'>
                <div>
                ...
                <div>
                    ...
                    <p className="">Our mission is to ignite a passion for God and His Word, bringing spiritual revival to communities
                ...
                <div>
                    ...
                    <p className="">Our vision is to be a fountain of spiritual renewal, where people from all walks of life are 
